...
// ★ v4.1: ShortsThumbnail barColor/barHeight/logo/cta
// ═══════════════════════════════════════════════════════════
...
import { ShortsThumbnail } from './compositions/ShortsThumbnail';
...
// ── 숏폼 썸네일 기본 Props ──
const defaultShortsThumbnailProps = {
  titleLines: ['숏폼으로', '월 100만원', '수익 만들기'],
  backgroundSrc: null,
  accentColor: '#FF6B35',
  channelName: '유튜브도사',
  style: 'bold',
...
export const RemotionRoot = () => {
  ...
  return (
    <>
      ...
      {/* 숏폼 썸네일 (정지 이미지 1080×1920) */}
      <Still
        id="ShortsThumbnail"
        component={ShortsThumbnail}
        width={1080}
        height={1920}
        defaultProps={defaultShortsThumbnailProps}
      />
    </>
  );
};
